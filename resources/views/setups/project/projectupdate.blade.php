                        ...
                        <div class="col-md-12">
                            <form action="{{ url('update-project',$project_edit->id) }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control-md" name="company_name" id="company_name">
                                                    ...
                                                    <option value="{{$company->id}}"
														{{$company->id == $project_edit->company_id ? 'selected' : ''}}>
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control-md" name="unit_name" id="unit_name">
													...
													{{$unit->id == $project_edit->unit_id ? 'selected' : ''}}>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                          <select class="form-control-md" name="country_name" id="country_name">
													...
													{{$country->id == $project_edit->country_id ? 'selected' : ''}}>
                                    ...
                                    <div class="col-sm-3">
												...
												<select class="form-control-md" name="customer_name" id="customer_name">
													...
													{{$customer->id == $project_edit->customer_id ? 'selected' : ''}}>
								 ...
								 <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                       <input type="text" class="form-control form-control-sm" name="project_name"
                                                id="project_name" value="{{$project_edit->project_name}}" placeholder="Enter Project Name">
                                    </div>
                                    <label class="col-sm-3 col-form-label col-form-label-sm">Project Code</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control form-control-sm" name="project_code" value="{{$project_edit->project_code}}"
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                       <input type="date" class="form-control form-control-sm" name="project_start_date" value="{{$project_edit->project_start_date}}"
                                    ...
                                    <div class="col-sm-3">
                                        <input type="date" class="form-control form-control-sm" name="project_end_date" value="{{$project_edit->project_end_date}}"
