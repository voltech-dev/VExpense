        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ url('update-division',$division->id) }}" method="POST">
                                @csrf
								@method('PUT')
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control-md" name="company_name" id="company_name">
													...
													{{$company->id == $division->company_id ? 'selected' : ''}}>
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control-md" name="unit_name" id="unit_name">
													...
													{{$unit->id == $division->unit_id ? 'selected' : ''}}>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                       <input type="text" class="form-control form-control-sm" name="division_name"
                                                id="division_name"  value="{{$division->division_name}}" placeholder="Enter Division Name">
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control form-control-sm" name="division_code"
                                                id="division_code" value="{{$division->division_code}}" placeholder="Enter Division Code">
                                    </div>
                                </div>
